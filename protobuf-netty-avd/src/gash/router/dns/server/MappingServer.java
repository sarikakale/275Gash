	...
	private static class StartHostCommunication implements Runnable{
		...
		public  void run() {
			...
			try {
				...
				bootstrap.put(IPList.getClientfacingport(), b);
				...
				b.childHandler(new WorkInitDNS(compressComm));
				
				ChannelFuture f = b.bind(IPList.getClientfacingport()).syncUninterruptibly();
