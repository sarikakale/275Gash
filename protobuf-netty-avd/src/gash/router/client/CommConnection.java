...
public class CommConnection {
	...
	public static CommConnection initConnection(String host, int port) {
		// get the instance , starts the constructor and init the Netty connection
	 ...
	 */
	public synchronized void enqueue(CommandMessage req) throws Exception {
		// enqueue message
		outbound.put(req);
	}
	...
	private void initCommConnection(){
		System.out.println("--> initializing connection to " + host + ":" + port);
