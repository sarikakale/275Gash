...
import gash.router.client.RequestClientFacingServer;
...
public class DemoApp implements CommListener {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (IPList.isRead()) {
				temp = false;
				/*IPList.setHostIP("192.168.1.52");
				IPList.setHostPort(3000);*/
				MessageClient mc = new MessageClient(IPList.getHostIP(), IPList.getHostport());
